                ...
                <div class=" w-full max-w-xs">
                    <label class="block form-control">
                        ...
                        <input type="text" placeholder="Apple"
                            class="input text-white input-bordered input-warning w-full max-w-xs" name="type" value="{{ $fruit->type }}" required />
                    </label>
                    ...
                    <label class="block form-control">
                        ...
                        <input type="text" placeholder="01kg"
                            class="input text-white input-bordered input-warning w-full max-w-xs" name="quantity" value="{{ $fruit->quantity }}"  required />
                    </label>
                    ...
                    <label class="block form-control">
                        ...
                        <input type="text" placeholder="e.g Rp.1000"
                            class="input text-white input-bordered input-warning w-full max-w-xs" name="price" value="{{ $fruit->price }}" required />
                    </label>
